                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent && !parent.querySelector(".brand-fallback")) {
                      ...
                      span.className =
                        "brand-fallback font-display text-xl text-[#062A40] tracking-wide text-center";
            ...
            <Reveal key={i} delay={((i % 3) + 1) as 1 | 2 | 3}>
              <div className="relative text-center px-4">
                <div
                  ...
                  style={{ color: "rgba(0,150,199,0.10)" }}
                >
                  {s.n}
                </div>
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "0 12px 30px -10px rgba(0,150,199,0.45)",
                  }}
                >
                  {s.icon}
                </div>
...
function FAQ() {
  const faqs = [
    ...
    { q: "Têm frete grátis?", a: "Sim! Frete grátis para toda a região." },
    {
      ...
      a: "Você nos conta o problema pelo WhatsApp ou pessoalmente. Nossos técnicos identificam a causa e indicam a solução em até 10 minutos.",
    },
  ];
